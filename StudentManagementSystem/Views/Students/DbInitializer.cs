...
namespace StudentManagementSystem.Data
{
	public static class DbInitializer
	{
		...
		{
			new StudentResult{StudentId=1, Subject="Math", Marks=80, MaxMarks=100},
			new StudentResult{StudentId=1, Subject="English", Marks=70, MaxMarks=100},
			new StudentResult{StudentId=2, Subject="Math", Marks=60, MaxMarks=100},
			new StudentResult{StudentId=2, Subject="English", Marks=75, MaxMarks=100}
		};
